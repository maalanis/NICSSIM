  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-lg p-3">
        <p className="text-xs text-muted-foreground">
          <span className="font-semibold text-primary">Research Finding:</span> Variance-based features 
          detected stealthy attacks that evaded signature-based detection
        </p>
      </div>
    </div>
  );
