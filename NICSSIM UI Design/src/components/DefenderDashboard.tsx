      ...
      <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Developing a two-agent AI system for nuclear ICS security: an attack generator 
              using reinforcement learning creates novel attacks while an adaptive defender 
              employs anomaly detection and ensemble ML models to counter them. Target metrics: 
              90-95% detection rate, &lt;2% false positives, 15-30s detection time.
            </p>
          </div>
        </div>
      </div>
